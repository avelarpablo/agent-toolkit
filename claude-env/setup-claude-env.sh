...
# Skills are deliberately NOT handled here — `toolkit sync` owns them, because
# skills are the thing that should *differ* between accounts (see accounts.json).
# This script owns only what should be identical everywhere.
# ──────────────────────────────────────────────────────────────────────────────
